...
export default class PageNavigation extends CustomElement {
    ...
    getPages() {
        return [{ name: 'home', title: 'Home', route: '/'}].concat([{"name":"administrator_role","title":"Administrator Role","description":"Define accounts that can perform certain admin functions.","category":"Access Control","route":"/administrator_role"},{"name":"token","title":"Custom Token","description":"Create a token for tracking value associated with your dapp.","category":"Asset and Value Tracking","route":"/token"},{"name":"entity","title":"Entity Collection","description":"Manage a collection of items.","category":"Collection","route":"/entity"},{"name":"ipfs","title":"IPFS Documents","description":"InterPlanetary File System (decentralized file storage)","category":"File Storage","route":"/ipfs"}]); 
    }
